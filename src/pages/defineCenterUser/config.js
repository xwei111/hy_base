...
export const formConfig = {
	...
	userformConfig: [
		...
		{ type: 'select', placeholder: '请选择组织', key: 'organizeId', label: '所属组织', options: [] },
		{ type: 'cascader', placeholder: '请选择单位', key: 'orgId', label: '所属单位', options: [], props: { value: 'orgId', label: 'orgName' } },
		{ type: 'cascader', placeholder: '请选择部门', key: 'id', label: '所属部门', options: [] }
	],
